...
const OcrModal: React.FC<OcrModalProps> = ({ isOpen, onClose, onAddPlays, interpretTicketImage, fileToBase64 }) => {
    ...
    const handleProcess = async () => {
        ...
        try {
            ...
            const results = await interpretTicketImage(base64String);
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50 animate-fade-in" onClick={handleClose}>
            <div className="bg-light-card dark:bg-dark-card rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-6 space-y-4 overflow-y-auto">
                    ...
                    {preview && (
                        <div className="text-center">
                            ...
                            <button onClick={() => { setFile(null); setPreview(null); setOcrResults([]); }} className="mt-2 text-sm text-red-500 hover:underline">Clear Image</button>
                        </div>
                    )}
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                    ...
                    {ocrResults.length > 0 ? (
                        <button onClick={handleAddResults} className="px-4 py-2 rounded-lg bg-neon-cyan text-black font-bold hover:opacity-90 transition-opacity">Add {ocrResults.length} Plays</button>
                    ) : (
